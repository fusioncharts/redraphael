_window.Raphael && (_window.Raphael.define && function (R) {
    ...
    reposition = R.ca[TEXTBOUND].reposition = function (params, leader) {
        ...
        if (!(params.hasOwnProperty(TEXTBOUND) || params.hasOwnProperty('x') || params.hasOwnProperty('y') || params.hasOwnProperty('text') || params.hasOwnProperty('text-anchor') || params.hasOwnProperty('text-align') || params.hasOwnProperty('font-size') || params.hasOwnProperty('line-height') || params.hasOwnProperty('vertical-align') || params.hasOwnProperty('transform') || params.hasOwnProperty('rotation'))) {
            return;
        }

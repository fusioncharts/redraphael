...
parent.canvas&&parent.canvas.appendChild(node),o.node=o[0]=node,node.raphael=!0,node.raphaelid=o.id=_raphael2["default"]._oid++,o.matrix=_raphael2["default"].matrix(),o.realPath=null,o.attrs=o.attrs||{},o.followers=o.followers||[],o.paper=svg,o.ca=o.customAttributes=o.customAttributes||new svg._CustomAttributes,o._={transform:[],sx:1,sy:1,deg:0,dx:0,dy:0,dirty:1},o.parent=parent,!parent.bottom&&(parent.bottom=o),o.prev=parent.top,parent.top&&(parent.top.next=o),parent.top=o,o.next=null},elproto=_raphael2["default"].el;Element.prototype=elproto,elproto.constructor=Element,_raphael2["default"]._engine.getNode=function(el){var node=el.node||el[0].node;return node.titleNode||node},_raphael2["default"]._engine.getLastNode=function(el){var node=el.node||el[el.length-1].node;return node.titleNode||node},elproto.rotate=function(deg,cx,cy){var bbox,o=this;return o.removed?o:(updateFollowers(o,"rotate",deg,cx,cy),deg=Str(deg).split(separator),deg.length-1&&(cx=toFloat(deg[1]),cy=toFloat(deg[2])),deg=toFloat(deg[0]),null==cy&&(cx=cy),null!=cx&&null!=cy||(bbox=o.getBBox(1),cx=bbox.x+bbox.width/2,cy=bbox.y+bbox.height/2),o.transform(o._.transform.concat([["r",deg,cx,cy]])),o)},elproto.scale=function(sx,sy,cx,cy){var bbox,o=this;return o.removed?o:(updateFollowers(o,"scale",sx,sy,cx,cy),sx=Str(sx).split(separator),sx.length-1&&(sy=toFloat(sx[1]),cx=toFloat(sx[2]),cy=toFloat(sx[3])),sx=toFloat(sx[0]),null==sy&&(sy=sx),null==cy&&(cx=cy),null!=cx&&null!=cy||(bbox=o.getBBox(1)),cx=null==cx?bbox.x+bbox.width/2:cx,cy=null==cy?bbox.y+bbox.height/2:cy,o.transform(o._.transform.concat([["s",sx,sy,cx,cy]])),o)},elproto.translate=function(dx,dy){var o=this;return o.removed?o:(updateFollowers(o,"translate",dx,dy),dx=Str(dx).split(separator),dx.length-1&&(dy=toFloat(dx[1])),dx=toFloat(dx[0])||0,dy=+dy||0,o.transform(o._.transform.concat([["t",dx,dy]])),o)},elproto.transform=function(tstr){var sw,o=this,_=o._;return null==tstr?_.transform:(_raphael2["default"]._extractTransform(o,tstr),o.clip&&!_.clipispath&&$(o.clip,{transform:o.matrix.invert()}),o.pattern&&updatePosition(o),o.node&&$(o.node,{transform:o.matrix}),sw=o.attrs[has]("stroke-width")?o.attrs["stroke-width"]:1,o.attr({"stroke-width":sw}),o)},elproto.hide=function(){var o=this;return updateFollowers(o,"hide"),!o.removed&&o.paper.safari(o.node.style.display="none"),o},elproto.show=function(){var o=this;return updateFollowers(o,"show"),!o.removed&&o.paper.safari(o.node.style.display=E),o},elproto.remove=function(){if(!this.removed&&this.parent.canvas){var i,o=this,node=_raphael2["default"]._engine.getNode(o),paper=o.paper,defs=paper.defs;for(paper.__set__&&paper.__set__.exclude(o),eve.unbind("raphael.*.*."+o.id),o.gradient&&defs&&updateGradientReference(o);i=o.followers.pop();)i.el.remove();for(;i=o.bottom;)i.remove();if(o._drag&&o.undrag(),o.events)for(;i=o.events.pop();)i.unbind();o.parent.canvas.contains(node)&&o.parent.canvas.removeChild(node),o.removeData(),delete paper._elementsById[o.id],_raphael2["default"]._tear(o,o.parent);for(i in o)o[i]="function"==typeof o[i]?_raphael2["default"]._removedFactory(i):null;o.removed=!0}},elproto._getCustomBBox=function(fontFamily,fontSize,valign,lines){var fn,hide,cachedFontHeight,txtElem,theMSG,availableFontFamily,availableFontSize,randomPos,bboxY,diff,bbox,bboxHeight,o=this,node=o.node,isText="text"===o.type,isIE=!!document.documentMode;if(isIE&&isText?fn=showRecursively(o):"none"===node.style.display&&(o.show(),hide=!0),isText){switch(cachedFontHeight=_raphael2["default"].cachedFontHeight,txtElem=cachedFontHeight.txtElem,availableFontFamily=cachedFontHeight[fontFamily]||(cachedFontHeight[fontFamily]={}),availableFontSize=availableFontFamily[fontSize],randomPos=-100,availableFontSize||(txtElem||(txtElem=cachedFontHeight.txtElem=document.createElementNS("http://www.w3.org/2000/svg","text"),txtElem.setAttribute("x",randomPos),txtElem.setAttribute("y",randomPos),theMSG=document.createTextNode("abcdefhiklmnopqrstuvwxyz"),txtElem.appendChild(theMSG),document.getElementsByTagName("svg")[0].appendChild(txtElem)),txtElem.setAttribute("style","font-family :"+fontFamily+"; font-size :"+fontSize),bbox=txtElem.getBBox(),availableFontFamily[fontSize]=availableFontSize=[],availableFontSize.push(bbox.height),availableFontSize.push(bbox.y)),bboxY=availableFontSize[1],bboxHeight=availableFontSize[0],valign){case"bottom":diff=randomPos-bboxY-bboxHeight*lines;break;case"top":diff=randomPos-bboxY;break;default:diff=randomPos-bboxY-bboxHeight/2*lines}bbox={height:availableFontSize[0],diff:diff}}return isIE&&isText?fn&&fn():hide&&o.hide(),bbox},elproto._getBBox=function(){var fn,align,hide,o=this,node=o.node,bbox={},a=o.attrs,isText="text"===o.type,isIE=!!document.documentMode;isIE&&isText?fn=showRecursively(o):"none"===node.style.display&&(o.show(),hide=!0);try{bbox=node.getBBox(),isText&&(bbox.x===undefined&&(bbox.isCalculated=!0,align=a["text-anchor"],bbox.x=(a.x||0)-bbox.width*("start"===align?0:"middle"===align?.5:1)),bbox.y===undefined&&(bbox.isCalculated=!0,align=a["vertical-align"],bbox.y=(a.y||0)-bbox.height*("bottom"===align?1:"middle"===align?.5:0)))}catch(e){}finally{bbox=bbox||{}}return isIE&&isText?fn&&fn():hide&&o.hide(),bbox},elproto.attr=function(name,value){if(this.removed)return this;if(null==name){var res={};for(var a in this.attrs)this.attrs[has](a)&&(res[a]=this.attrs[a]);return res.gradient&&"none"==res.fill&&(res.fill=res.gradient)&&delete res.gradient,res.transform=this._.transform,res.visibility="none"===this.node.style.display?"hidden":"visible",res}if(null==value&&_raphael2["default"].is(name,"string")){if("fill"==name&&"none"==this.attrs.fill&&this.attrs.gradient)return this.attrs.gradient;if("transform"==name)return this._.transform;if("visibility"==name)return"none"===this.node.style.display?"hidden":"visible";for(var names=name.split(separator),out={},i=0,ii=names.length;i<ii;i++)name=names[i],name in this.attrs?out[name]=this.attrs[name]:_raphael2["default"].is(this.ca[name],"function")?out[name]=this.ca[name].def:out[name]=_raphael2["default"]._availableAttrs[name];return ii-1?out:out[names[0]]}if(null==value&&_raphael2["default"].is(name,"array")){for(out={},i=0,ii=name.length;i<ii;i++)out[name[i]]=this.attr(name[i]);return out}if(null!=value){var params={};params[name]=value}else null!=name&&_raphael2["default"].is(name,"object")&&(params=name);if(!1!==_raphael2["default"].stopEvent)for(var key in params)eve("raphael.attr."+key+"."+this.id,this,params[key],key);var todel={};for(key in this.ca)if(this.ca[key]&&params[has](key)&&_raphael2["default"].is(this.ca[key],"function")&&!this.ca["_invoked"+key]){this.ca["_invoked"+key]=!0;var par=this.ca[key].apply(this,[].concat(params[key]));delete this.ca["_invoked"+key];for(var subkey in par)par[has](subkey)&&(params[subkey]=par[subkey]);this.attrs[key]=params[key],!1===par&&(todel[key]=params[key],delete params[key])}setFillAndStroke(this,params);var follower;for(i=0,ii=this.followers.length;i<ii;i++)follower=this.followers[i],follower.cb&&!follower.cb.call(follower.el,params,this)||follower.el.attr(params);for(subkey in todel)params[subkey]=todel[subkey];return this},elproto.blur=function(size){var t=this;if(0!=+size){var fltr=$("filter"),blur=$("feGaussianBlur");t.attrs.blur=size,fltr.id=_raphael2["default"].getElementID(_raphael2["default"].createUUID()),$(blur,{stdDeviation:+size||1.5}),fltr.appendChild(blur),t.paper.defs.appendChild(fltr),t._blur=fltr,$(t.node,{filter:"url('"+_raphael2["default"]._url+"#"+fltr.id+"')"})}else t._blur&&(t._blur.parentNode.removeChild(t._blur),delete t._blur,delete t.attrs.blur),t.node.removeAttribute("filter")},elproto.on=function(eventType,handler){var fn,oldEventType,elem=this;return this.removed?this:"dragstart"===eventType?(this.drag(null,handler),this):"dragmove"===eventType?(this.drag(handler),this):"dragend"===eventType?(this.drag(null,null,handler),this):(fn=handler,oldEventType=eventType,_raphael2["default"].supportsTouch&&(eventType=_raphael2["default"]._touchMap[eventType]||"click"===eventType&&"touchstart"||eventType)!==oldEventType&&(elem._tempTouchListeners||(elem._tempTouchListeners={}),elem._tempTouchListeners[oldEventType]||(elem._tempTouchListeners[oldEventType]=[]),fn=function(e){e.preventDefault(),handler(e)},elem._tempTouchListeners[oldEventType].push({oldFn:handler,newFn:fn,newEvt:eventType})),this.node.addEventListener?this.node.addEventListener(eventType,fn):this.node["on"+eventType]=fn,this)},elproto.off=function(eventType,handler){var fn,i,l,oldEventType,elem=this;if(this.removed)return this;if("dragstart"===eventType)return this.undragstart(),this;if("dragmove"===eventType)return this.undragmove(),this;if("dragend"===eventType)return this.undragend(),this;if(fn=handler,oldEventType=eventType,_raphael2["default"].supportsTouch&&elem._tempTouchListeners&&elem._tempTouchListeners[oldEventType])for(l=elem._tempTouchListeners[oldEventType].length,i=0;i<l&&oldEventType===eventType;i+=1)elem._tempTouchListeners[oldEventType][i]&&elem._tempTouchListeners[oldEventType][i].oldFn===fn&&(eventType=elem._tempTouchListeners[oldEventType][i].newEvt,fn=elem._tempTouchListeners[oldEventType][i].newFn,elem._tempTouchListeners[oldEventType].splice(i,1));return this.node.removeEventListener?this.node.removeEventListener(eventType,fn):this.node["on"+eventType]=null,this},_raphael2["default"]._engine.path=function(svg,attrs,group){var el=$("path"),res=new Element(el,svg,group);return res.type="path",setFillAndStroke(res,attrs),applyCustomAttributes(res,attrs),res},_raphael2["default"]._engine.group=function(svg,id,group){var el=$("g"),res=new Element(el,svg,group);return res.type="group",res.canvas=res.node,res.top=res.bottom=null,res._id=id||E,id&&el.setAttribute("class","raphael-group-"+res.id+"-"+id),res},_raphael2["default"]._engine.circle=function(svg,attrs,group){var el=$("circle"),res=new Element(el,svg,group);return res.type="circle",setFillAndStroke(res,attrs),applyCustomAttributes(res,attrs),res},_raphael2["default"]._engine.rect=function(svg,attrs,group){var el=$("rect"),res=new Element(el,svg,group);return res.type="rect",attrs.rx=attrs.ry=attrs.r,setFillAndStroke(res,attrs),applyCustomAttributes(res,attrs),res},_raphael2["default"]._engine.ellipse=function(svg,attrs,group){var el=$("ellipse"),res=new Element(el,svg,group);return res.type="ellipse",setFillAndStroke(res,attrs),applyCustomAttributes(res,attrs),res},_raphael2["default"]._engine.image=function(svg,attrs,group){var el=$("image"),res=(attrs.src,new Element(el,svg,group,!0));return res._.group=group||svg,res.type="image",el.setAttribute("preserveAspectRatio","none"),setFillAndStroke(res,attrs),applyCustomAttributes(res,attrs),res},_raphael2["default"]._engine.text=function(svg,attrs,group,css){var el=$("text"),res=new Element(el,svg,group);return res.type="text",res._textdirty=!0,css&&res.css&&res.css(css,undefined,!0),setFillAndStroke(res,attrs,group),applyCustomAttributes(res,attrs),res},_raphael2["default"]._engine.setSize=function(width,height){return this.width=width||this.width,this.height=height||this.height,this.canvas.setAttribute("width",this.width),this.canvas.setAttribute("height",this.height),this._viewBox&&this.setViewBox.apply(this,this._viewBox),this},_raphael2["default"]._engine.create=function(){var con=_raphael2["default"]._getContainer.apply(0,arguments),container=con&&con.container,x=con.x,y=con.y,width=con.width,height=con.height;if(!container)throw new Error("SVG container not found.");var isFloating,cnvs=$("svg"),css="overflow:hidden;-webkit-tap-highlight-color:rgba(0,0,0,0);-webkit-user-select:none;-moz-user-select:-moz-none;-khtml-user-select:none;-ms-user-select:none;user-select:none;-o-user-select:none;cursor:default;",css=css+"vertical-align:middle;";return x=x||0,y=y||0,width=width||512,height=height||342,$(cnvs,{height:height,version:1.1,width:width,xmlns:"http://www.w3.org/2000/svg"}),1==container?(cnvs.style.cssText=css+"position:absolute;left:"+x+"px;top:"+y+"px",_raphael2["default"]._g.doc.body.appendChild(cnvs),isFloating=1):(cnvs.style.cssText=css+"position:relative",container.firstChild?container.insertBefore(cnvs,container.firstChild):container.appendChild(cnvs)),container=new _raphael2["default"]._Paper,container.width=width,container.height=height,container.canvas=cnvs,$(cnvs,{id:"raphael-paper-"+container.id}),container.clear(),container._left=container._top=0,isFloating&&(container.renderfix=function(){}),container.renderfix(),container},_raphael2["default"]._engine.setViewBox=function(x,y,w,h,fit){eve("raphael.setViewBox",this,this._viewBox,[x,y,w,h,fit]);var vb,sw,size=mmax(w/this.width,h/this.height),top=this.top,aspectRatio=fit?"meet":"xMinYMin";for(null==x?(this._vbSize&&(size=1),delete this._vbSize,vb="0 0 "+this.width+S+this.height):(this._vbSize=size,vb=x+S+y+S+w+S+h),$(this.canvas,{viewBox:vb,preserveAspectRatio:aspectRatio});size&&top;)sw="stroke-width"in top.attrs?top.attrs["stroke-width"]:1,top.attr({"stroke-width":sw}),top._.dirty=1,top._.dirtyT=1,top=top.prev;return this._viewBox=[x,y,w,h,!!fit],this},_raphael2["default"].prototype.renderfix=function(){var pos,cnvs=this.canvas,s=cnvs.style;try{pos=cnvs.getScreenCTM()||cnvs.createSVGMatrix()}catch(e){pos=cnvs.createSVGMatrix()}var left=-pos.e%1,top=-pos.f%1;(left||top)&&(left&&(this._left=(this._left+left)%1,s.left=this._left+"px"),top&&(this._top=(this._top+top)%1,s.top=this._top+"px"))},_raphael2["default"].prototype._desc=function(txt){var desc=this.desc;if(desc)for(;desc.firstChild;)desc.removeChild(desc.firstChild);else this.desc=desc=$("desc"),this.canvas.appendChild(desc);desc.appendChild(_raphael2["default"]._g.doc.createTextNode(_raphael2["default"].is(txt,"string")?txt:"Created with Red Raphaël "+_raphael2["default"].version))},_raphael2["default"].prototype.clear=function(){var c;for(eve("raphael.clear",this);c=this.bottom;)c.remove();for(c=this.canvas;c.firstChild;)c.removeChild(c.firstChild);this.bottom=this.top=null,c.appendChild(this.desc=$("desc")),c.appendChild(this.defs=$("defs"))},_raphael2["default"].prototype.remove=function(){var i;for(eve("raphael.remove",this);i=this.bottom;)i.remove();this.defs&&this.defs.parentNode.removeChild(this.defs),this.desc&&this.desc.parentNode.removeChild(this.desc),this.canvas.parentNode&&this.canvas.parentNode.removeChild(this.canvas);for(i in this)this[i]="function"==typeof this[i]?_raphael2["default"]._removedFactory(i):null;this.removed=!0};var setproto=_raphael2["default"].st;for(var method in elproto)elproto[has](method)&&!setproto[has](method)&&(setproto[method]=function(methodname){return function(){var arg=arguments;return this.forEach(function(el){el[methodname].apply(el,arg)})}}(method))}/**!
  ...
  */
exports["default"]=_raphael2["default"],module.exports=exports["default"]},function(module,exports,__webpack_require__){"use strict";exports.__esModule=!0;var _raphael=__webpack_require__(7),_raphael2=function(obj){return obj&&obj.__esModule?obj:{"default":obj}}(_raphael);if(_raphael2["default"].vml){var has="hasOwnProperty",Str=String,toFloat=parseFloat,math=Math,round=math.round,mmax=math.max,mmin=math.min,sqrt=math.sqrt,abs=math.abs,separator=/[, ]+/,eve=_raphael2["default"].eve,paperproto=_raphael2["default"].fn,serializeArgs=_raphael2["default"]._serializeArgs,arrayShift=Array.prototype.shift,S=" ",E="",map={M:"m",L:"l",C:"c",Z:"x",m:"t",l:"r",c:"v",z:"x"},bites=/([clmz]),?([^clmz]*)/gi,blurregexp=/ progid:\S+Blur\([^\)]+\)/g,val=/-?[^,\s-]+/g,cssDot="position:absolute;left:0;top:0;width:1px;height:1px",zoom=21600,pathTypes={path:1,rect:1,image:1},ovalTypes={circle:1,ellipse:1},path2vml=function(path){var total=/[ahqstv]/gi,command=_raphael2["default"]._pathToAbsolute;if(Str(path).match(total)&&(command=_raphael2["default"]._path2curve),total=/[clmz]/g,command==_raphael2["default"]._pathToAbsolute&&!Str(path).match(total)){var res=Str(path).replace(bites,function(all,command,args){var vals=[],isMove="m"==command.toLowerCase(),res=map[command];return args.replace(val,function(value){isMove&&2==vals.length&&(res+=vals+map["m"==command?"l":"L"],vals=[]),vals.push(round(value*zoom))}),res+vals});return res||"m0,0"}var p,r,pa=command(path);res=[];for(var i=0,ii=pa.length;i<ii;i++){p=pa[i],r=pa[i][0].toLowerCase(),"z"==r&&(r="x");for(var j=1,jj=p.length;j<jj;j++)r+=round(p[j]*zoom)+(j!=jj-1?",":E);res.push(r)}return res.length?res.join(S):"m0,0"},compensation=function(deg,dx,dy){var m=_raphael2["default"].matrix();return m.rotate(-deg,.5,.5),{dx:m.x(dx,dy),dy:m.y(dx,dy)}},setCoords=function(p,sx,sy,dx,dy,deg){var _=p._,m=p.matrix,fillpos=_.fillpos,o=p.node,s=o.style,y=1,flip="",kx=zoom/sx,ky=zoom/sy;if(s.visibility="hidden",sx&&sy){if(o.coordsize=abs(kx)+S+abs(ky),s.rotation=deg*(sx*sy<0?-1:1),deg){var c=compensation(deg,dx,dy);dx=c.dx,dy=c.dy}if(sx<0&&(flip+="x"),sy<0&&(flip+=" y")&&(y=-1),s.flip=flip,o.coordorigin=dx*-kx+S+dy*-ky,fillpos||_.fillsize){var fill=o.getElementsByTagName("fill");fill=fill&&fill[0],fill&&(o.removeChild(fill),fillpos&&(c=compensation(deg,m.x(fillpos[0],fillpos[1]),m.y(fillpos[0],fillpos[1])),fill.position=c.dx*y+S+c.dy*y),_.fillsize&&(fill.size=_.fillsize[0]*abs(sx)+S+_.fillsize[1]*abs(sy)),o.appendChild(fill))}s.visibility="visible"}};_raphael2["default"]._url=E,_raphael2["default"].toString=function(){return"Your browser doesn’t support SVG. Falling down to VML.\nYou are running Raphaël "+this.version};var addArrow=function(o,value,isEnd){for(var values=Str(value).toLowerCase().split("-"),se=isEnd?"end":"start",i=values.length,type="classic",w="medium",h="medium";i--;)switch(values[i]){case"block":case"classic":case"oval":case"diamond":case"open":case"none":type=values[i];break;case"wide":case"narrow":h=values[i];break;case"long":case"short":w=values[i]}var stroke=o.node.getElementsByTagName("stroke")[0];stroke[se+"arrow"]=type,stroke[se+"arrowlength"]=w,stroke[se+"arrowwidth"]=h},applyCustomAttributes=function(o,attrs){for(var key in attrs)eve("raphael.attr."+key+"."+o.id,o,attrs[key],key),o.ca[key]&&o.attr(key,attrs[key])},setFillAndStroke=_raphael2["default"]._setFillAndStroke=function(o,params){if(o.paper.canvas){o.attrs=o.attrs||{};var oriOp,node=o.node,a=o.attrs,s=node.style,newpath=pathTypes[o.type]&&(params.x!=a.x||params.y!=a.y||params.width!=a.width||params.height!=a.height||params.cx!=a.cx||params.cy!=a.cy||params.rx!=a.rx||params.ry!=a.ry||params.r!=a.r),isOval=ovalTypes[o.type]&&(a.cx!=params.cx||a.cy!=params.cy||a.r!=params.r||a.rx!=params.rx||a.ry!=params.ry),isGroup="group"===o.type,res=o;oriOp=res.oriOp||(res.oriOp={});for(var par in params)params[has](par)&&(a[par]=params[par]);if(newpath&&(a.path=_raphael2["default"]._getPath[o.type](o),o._.dirty=1),params.href&&(node.href=params.href),params.title&&(node.title=params.title),params.target&&(node.target=params.target),params.cursor&&(s.cursor=params.cursor),"blur"in params&&o.blur(params.blur),(params.path&&"path"==o.type||newpath)&&(node.path=path2vml(~Str(a.path).toLowerCase().indexOf("r")?_raphael2["default"]._pathToAbsolute(a.path):a.path),"image"==o.type&&(o._.fillpos=[a.x,a.y],o._.fillsize=[a.width,a.height],setCoords(o,1,1,0,0,0))),"transform"in params&&o.transform(params.transform),"rotation"in params){var rotation=params.rotation;_raphael2["default"].is(rotation,"array")?o.rotate.apply(o,rotation):o.rotate(rotation)}if("visibility"in params&&("hidden"===params.visibility?o.hide():o.show()),isOval){var cx=+a.cx,cy=+a.cy,rx=+a.rx||+a.r||0,ry=+a.ry||+a.r||0;node.path=_raphael2["default"].format("ar{0},{1},{2},{3},{4},{1},{4},{1}x",round((cx-rx)*zoom),round((cy-ry)*zoom),round((cx+rx)*zoom),round((cy+ry)*zoom),round(cx*zoom))}if("clip-rect"in params){var rect=Str(params["clip-rect"]).split(separator);if(4==rect.length){rect[0]=+rect[0],rect[1]=+rect[1],rect[2]=+rect[2]+rect[0],rect[3]=+rect[3]+rect[1];var offset,div=isGroup?node:node.clipRect||_raphael2["default"]._g.doc.createElement("div"),dstyle=div.style;isGroup?(o.clip=rect.slice(),offset=o.matrix.offset(),offset=[toFloat(offset[0]),toFloat(offset[1])],rect[0]-=offset[0],rect[1]-=offset[1],rect[2]-=offset[0],rect[3]-=offset[1],dstyle.width="1px",dstyle.height="1px"):node.clipRect||(dstyle.top="0",dstyle.left="0",dstyle.width=o.paper.width+"px",dstyle.height=o.paper.height+"px",node.parentNode.insertBefore(div,node),div.appendChild(node),div.raphael=!0,div.raphaelid=node.raphaelid,node.clipRect=div),dstyle.position="absolute",dstyle.clip=_raphael2["default"].format("rect({1}px {2}px {3}px {0}px)",rect)}params["clip-rect"]||(isGroup&&o.clip?(node.style.clip="rect(0px 10800px 10800px 0px)",delete o.clip):node.clipRect&&(node.clipRect.style.clip="rect(0px 10800px 10800px 0px)"))}if(o.textpath||isGroup){var textpathStyle=isGroup?node.style:o.textpath.style;params.font&&(textpathStyle.font=params.font),params["font-family"]&&(textpathStyle.fontFamily='"'+params["font-family"].split(",")[0].replace(/^['"]+|['"]+$/g,E)+'"'),params["font-size"]&&(textpathStyle.fontSize=params["font-size"]),params["font-weight"]&&(textpathStyle.fontWeight=params["font-weight"]),params["font-style"]&&(textpathStyle.fontStyle=params["font-style"])}if("arrow-start"in params&&addArrow(res,params["arrow-start"]),"arrow-end"in params&&addArrow(res,params["arrow-end"],1),!isGroup&&(null!=params.opacity||null!=params["stroke-width"]||null!=params.fill||null!=params.src||null!=params.stroke||null!=params["stroke-width"]||null!=params["stroke-opacity"]||null!=params["fill-opacity"]||null!=params["stroke-dasharray"]||null!=params["stroke-miterlimit"]||null!=params["stroke-linejoin"]||null!=params["stroke-linecap"])){var fill=node.getElementsByTagName("fill"),fillOpacity=-1;if(fill=fill&&fill[0],!fill&&(fill=createNode("fill")),"image"==o.type&&params.src&&(fill.src=params.src),params.fill&&(fill.on=!0),null!=fill.on&&"none"!=params.fill&&null!==params.fill||(fill.on=!1),fill.on&&params.fill){var isURL=Str(params.fill).match(_raphael2["default"]._ISURL);if(isURL){fill.parentNode==node&&node.removeChild(fill),fill.rotate=!0,fill.src=isURL[1],fill.type="tile";var bbox=o.getBBox(1);fill.position=bbox.x+S+bbox.y,o._.fillpos=[bbox.x,bbox.y],_raphael2["default"]._preload(isURL[1],function(){o._.fillsize=[this.offsetWidth,this.offsetHeight]})}else{var color=_raphael2["default"].getRGB(params.fill);fill.color=color.hex,fill.src=E,fill.type="solid",color.error&&(res.type in{circle:1,ellipse:1}||"r"!=Str(params.fill).charAt())&&addGradientFill(res,params.fill,fill)?(a.fill="none",a.gradient=params.fill,fill.rotate=!1):"opacity"in color&&!("fill-opacity"in params)&&(oriOp.nonGradOpacity=fillOpacity=color.opacity)}}if(-1!==fillOpacity||"fill-opacity"in params||"opacity"in params){var opacity=((+a["fill-opacity"]+1||2)-1)*((+a.opacity+1||2)-1)*((+fillOpacity+1||2)-1);opacity=mmin(mmax(opacity,0),1),oriOp.opacity=opacity,oriOp.opacity1!==undefined?(fill.opacity=oriOp.opacity1*opacity,fill["o:opacity2"]=oriOp.opacity2*opacity):fill.opacity=opacity*(oriOp.nonGradOpacity===undefined?1:oriOp.nonGradOpacity),fill.src&&(fill.color="none")}oriOp.opacity=undefined,node.appendChild(fill);var stroke=node.getElementsByTagName("stroke")&&node.getElementsByTagName("stroke")[0],newstroke=!1;!stroke&&(newstroke=stroke=createNode("stroke")),(params.stroke&&"none"!=params.stroke||params["stroke-width"]||null!=params["stroke-opacity"]||params["stroke-dasharray"]||params["stroke-miterlimit"]||params["stroke-linejoin"]||params["stroke-linecap"])&&(stroke.on=!0),("none"==params.stroke||null===params.stroke||null==stroke.on||0==params.stroke||0==params["stroke-width"])&&(stroke.on=!1);var strokeColor=_raphael2["default"].getRGB("stroke"in params?params.stroke:a.stroke);stroke.on&&params.stroke&&(stroke.color=strokeColor.hex),opacity=((+a["stroke-opacity"]+1||2)-1)*((+a.opacity+1||2)-1)*((+strokeColor.opacity+1||2)-1);var width=.75*(toFloat(params["stroke-width"])||1);if(opacity=mmin(mmax(opacity,0),1),null==params["stroke-width"]&&(width=a["stroke-width"]),params["stroke-width"]&&(stroke.weight=width),width&&width<1&&(opacity*=width)&&(stroke.weight=1),stroke.opacity=opacity,params["stroke-linejoin"]&&(stroke.joinstyle=params["stroke-linejoin"])||newstroke&&(newstroke.joinstyle="miter"),stroke.miterlimit=params["stroke-miterlimit"]||8,params["stroke-linecap"]&&(stroke.endcap="butt"==params["stroke-linecap"]?"flat":"square"==params["stroke-linecap"]?"square":"round"),params["stroke-dasharray"]){var dasharray={"-":"shortdash",".":"shortdot","-.":"shortdashdot","-..":"shortdashdotdot",". ":"dot","- ":"dash","--":"longdash","- .":"dashdot","--.":"longdashdot","--..":"longdashdotdot"};stroke.dashstyle=dasharray[has](params["stroke-dasharray"])?dasharray[params["stroke-dasharray"]]:params["stroke-dasharray"].join&&params["stroke-dasharray"].join(" ")||E}newstroke&&node.appendChild(stroke)}if("text"==res.type){res.paper.canvas.style.display=E;var span=res.paper.span,m=100,fontSize=a.font&&a.font.match(/\d+(?:\.\d*)?(?=px)/),lineHeight=a["line-height"]&&(a["line-height"]+E).match(/\d+(?:\.\d*)?(?=px)/);s=span.style,a.font&&(s.font=a.font),a["font-family"]&&(s.fontFamily=a["font-family"]),a["font-weight"]&&(s.fontWeight=a["font-weight"]),a["font-style"]&&(s.fontStyle=a["font-style"]),fontSize=toFloat(a["font-size"]||fontSize&&fontSize[0])||10,s.fontSize=fontSize*m+"px",lineHeight=toFloat(a["line-height"]||lineHeight&&lineHeight[0])||12,a["line-height"]&&(s.lineHeight=lineHeight*m+"px"),_raphael2["default"].is(params.text,"array")&&(params.text=res.textpath.string=params.text.join("\n").replace(/<br\s*?\/?>/gi,"\n")),res.textpath.string&&(span.innerHTML=Str(res.textpath.string).replace(/</g,"&#60;").replace(/&/g,"&#38;").replace(/\n/g,"<br>"));var brect=span.getBoundingClientRect();res.W=a.w=(brect.right-brect.left)/m,res.H=a.h=(brect.bottom-brect.top)/m,res.X=a.x,res.Y=a.y;switch(a["vertical-align"]){case"top":res.bby=res.H/2;break;case"bottom":res.bby=-res.H/2;break;default:res.bby=0}("x"in params||"y"in params||res.bby!==undefined)&&(res.path.v=_raphael2["default"].format("m{0},{1}l{2},{1}",round(a.x*zoom),round((a.y+(res.bby||0))*zoom),round(a.x*zoom)+1));for(var dirtyattrs=["x","y","text","font","font-family","font-weight","font-style","font-size","line-height"],d=0,dd=dirtyattrs.length;d<dd;d++)if(dirtyattrs[d]in params){res._.dirty=1;break}switch(a["text-anchor"]){case"start":res.textpath.style["v-text-align"]="left",res.bbx=res.W/2;break;case"end":res.textpath.style["v-text-align"]="right",res.bbx=-res.W/2;break;default:res.textpath.style["v-text-align"]="center",res.bbx=0}res.textpath.style["v-text-kern"]=!0}}},updateFollowers=_raphael2["default"]._updateFollowers=function(){var i,ii,followerElem,args=arguments,o=arrayShift.call(args),fnName=arrayShift.call(args);for(i=0,ii=o.followers.length;i<ii;i++)followerElem=o.followers[i].el,followerElem[fnName].apply(followerElem,args)},addGradientFill=function(o,gradient,fill){o.attrs=o.attrs||{};var oriFOpacity,pow=(o.attrs,Math.pow),oriOp=o.oriOp,type="linear",fxfy=".5 .5";if(o.attrs.gradient=gradient,gradient=Str(gradient).replace(_raphael2["default"]._radial_gradient,function(all,opts){type="radial",opts=opts&&opts.split(",")||[];var fx=(opts[0],opts[1],opts[2],opts[3]),fy=opts[4];opts[5];return fx&&fy&&(fx=toFloat(fx),fy=toFloat(fy),pow(fx-.5,2)+pow(fy-.5,2)>.25&&(fy=sqrt(.25-pow(fx-.5,2))*(2*(fy>.5)-1)+.5),fxfy=fx+S+fy),E}),gradient=gradient.split(/\s*\-\s*/),"linear"==type){var angle=gradient.shift();if(angle=-toFloat(angle),isNaN(angle))return null}var dots=_raphael2["default"]._parseDots(gradient);if(!dots)return null;if(o=o.shape||o.node,dots.length){fill.parentNode==o&&o.removeChild(fill),fill.on=!0,fill.method="none",fill.color=dots[0].color,fill.color2=dots[dots.length-1].color;for(var clrs=[],opacity1=1,opacity2=dots[0].opacity===undefined?1:dots[0].opacity,i=0,ii=dots.length;i<ii;i++)dots[i].offset&&clrs.push(dots[i].offset+S+dots[i].color),dots[i].opacity!==undefined&&(opacity1=dots[i].opacity);fill.colors=clrs.length?clrs.join():"0% "+fill.color,oriOp.opacity1=opacity1,oriOp.opacity2=opacity2,oriFOpacity=oriOp.opacity===undefined?1:oriOp.opacity,fill.opacity=opacity1*oriFOpacity,fill["o:opacity2"]=opacity2*oriFOpacity,"radial"==type?(fill.type="gradientTitle",fill.focus="100%",fill.focussize="0 0",fill.focusposition=fxfy,fill.angle=0):(fill.type="gradient",fill.angle=(270-angle)%360),o.appendChild(fill)}return 1},Element=function(node,vml,group){var skew,o=this,parent=group||vml;/*!dontAppend && */
parent.canvas&&parent.canvas.appendChild(node),skew=createNode("skew"),skew.on=!0,node.appendChild(skew),o.skew=skew,o.node=o[0]=node,node.raphael=!0,node.raphaelid=o.id=_raphael2["default"]._oid++,o.X=0,o.Y=0,o.attrs=o.attrs||{},o.followers=o.followers||[],o.paper=vml,o.ca=o.customAttributes=o.customAttributes||new vml._CustomAttributes,o.matrix=_raphael2["default"].matrix(),o._={transform:[],sx:1,sy:1,dx:0,dy:0,deg:0,dirty:1,dirtyT:1},o.parent=parent,!parent.bottom&&(parent.bottom=o),o.prev=parent.top,parent.top&&(parent.top.next=o),parent.top=o,o.next=null},elproto=_raphael2["default"].el,notApplicableGroupAttrs={fill:!0,stroke:!0,"stroke-width":!0,"stroke-dasharray":!0,"stroke-linejoin":!0,"stroke-opacity":!0,"fill-opacity":!0,opacity:!0},customGroupUpdate=function(attributes){var childElem,group=this,ownAttr=group.ownAttr;for(attributes&&(group.ownAttr=ownAttr?_raphael2["default"].extend(ownAttr,attributes):attributes),info=getApplicableGroupAttributes(group),group.customAttr=info.customAttr,group.inheritAttr=info.inheritAttr,childElem=group.bottom;childElem;)childElem.attr(),childElem=childElem.next;return attributes&&elproto.attr.call(group,attributes)},customElementUpdate=function(attributes){var element=this,parent=element.parent,ownAttr=element.ownAttr;return attributes&&(element.ownAttr=ownAttr?_raphael2["default"].extend(ownAttr,attributes):attributes),attributes=getApplicableAttributes(parent,attributes,element),element.inheritAttrFromGroup=parent&&parent.inheritAttr,element.customAttrFromGroup=parent&&parent.customAttr,elproto.attr.call(element,attributes)},getApplicableGroupAttributes=function(group){var attr,parent=group&&group.parent,customAttr={},inheritAttr={};if(ownAttr=group&&group.ownAttr,ownAttr)for(attr in ownAttr)notApplicableGroupAttrs[attr]&&(customAttr[attr]=ownAttr[attr]);if(parent&&"group"===parent.type){parentCustomAttr=parent.customAttr,parentInheritAttr=parent.inheritAttr;for(attr in parentCustomAttr)inheritAttr[attr]=parentCustomAttr[attr];for(attr in parentInheritAttr)!inheritAttr[attr]&&(inheritAttr[attr]=parentInheritAttr[attr])}return{customAttr:customAttr,inheritAttr:inheritAttr}},getApplicableAttributes=function(group,elemAttr,elem){var customAttr,inheritAttr,attr;if(elemAttr=elemAttr||_raphael2["default"].extend({},elem.ownAttr),group){customAttr=group.customAttr,inheritAttr=group.inheritAttr;for(attr in customAttr)!elemAttr[attr]&&(elemAttr[attr]=customAttr[attr]);for(attr in inheritAttr)!elemAttr[attr]&&(elemAttr[attr]=inheritAttr[attr])}return elemAttr};paperproto.group=function(){var out,paper=this,args=arguments,group=_raphael2["default"]._lastArgIfGroup(args,!0);return out=_raphael2["default"]._engine.group(paper,args[0],group),out.attr=customGroupUpdate,paper.__set__&&paper.__set__.push(out),paper._elementsById[out.id]=out},paperproto.circle=function(){var out,paper=this,args=arguments,group=_raphael2["default"]._lastArgIfGroup(args,!0),attrs=serializeArgs(args);return attrs=getApplicableAttributes(group,attrs),out=_raphael2["default"]._engine.circle(paper,attrs,group),out.attr=customElementUpdate,paper.__set__&&paper.__set__.push(out),paper._elementsById[out.id]=out},paperproto.rect=function(){var attrs,out,paper=this,args=arguments,group=_raphael2["default"]._lastArgIfGroup(args,!0),ownAttr=serializeArgs(args);return attrs=getApplicableAttributes(group,ownAttr),out=_raphael2["default"]._engine.rect(paper,attrs,group),out.attr=customElementUpdate,out.ownAttr=ownAttr,out.inheritAttrFromGroup=group.inheritAttr,out.customAttrFromGroup=group.customAttr,paper.__set__&&paper.__set__.push(out),paper._elementsById[out.id]=out},paperproto.ellipse=function(){var out,paper=this,args=arguments,group=_raphael2["default"]._lastArgIfGroup(args,!0),attrs=serializeArgs(args);return attrs=getApplicableAttributes(group,attrs),out=_raphael2["default"]._engine.ellipse(this,attrs,group),out.attr=customElementUpdate,paper.__set__&&paper.__set__.push(out),paper._elementsById[out.id]=out},paperproto.path=function(){var out,paper=this,args=arguments,group=_raphael2["default"]._lastArgIfGroup(args,!0),paperConfig=paper.config,attrs=(paperConfig&&paperConfig["stroke-linecap"],serializeArgs(args));return attrs=getApplicableAttributes(group,attrs),out=_raphael2["default"]._engine.path(paper,attrs,group),out.attr=customElementUpdate,paper.__set__&&paper.__set__.push(out),paper._elementsById[out.id]=out},paperproto.image=function(){var out,paper=this,args=arguments,group=_raphael2["default"]._lastArgIfGroup(args,!0),attrs=serializeArgs(args);return attrs=getApplicableAttributes(group,attrs),out=_raphael2["default"]._engine.image(paper,attrs,group),out.attr=customElementUpdate,paper.__set__&&paper.__set__.push(out),paper._elementsById[out.id]=out},paperproto.text=function(){var out,paper=this,args=arguments,group=_raphael2["default"]._lastArgIfGroup(args,!0),attrs=serializeArgs(args);return attrs=getApplicableAttributes(group,attrs),out=_raphael2["default"]._engine.text(paper,attrs,group,args[1]),paper.__set__&&paper.__set__.push(out),paper._elementsById[out.id]=out},Element.prototype=elproto,elproto.constructor=Element,elproto.transform=function(tstr){if(null==tstr)return this._.transform;var oldt,vbs=this.paper._viewBoxShift,vbt=vbs?"s"+[vbs.scale,vbs.scale]+"-1-1t"+[vbs.dx,vbs.dy]:E;vbs&&(oldt=tstr=Str(tstr).replace(/\.{3}|\u2026/g,this._.transform||E)),_raphael2["default"]._extractTransform(this,vbt+tstr);var split,matrix=this.matrix.clone(),skew=this.skew,o=this.node,isGrad=~Str(this.attrs.fill).indexOf("-"),isPatt=!Str(this.attrs.fill).indexOf("url(");if(matrix.translate(-.5,-.5),isPatt||isGrad||"image"==this.type)if(skew.matrix="1 0 0 1",skew.offset="0 0",split=matrix.split(),isGrad&&split.noRotation||!split.isSimple){o.style.filter=matrix.toFilter();var bb=this.getBBox(),bbt=this.getBBox(1),xget=bb.x2&&bbt.x2&&"x2"||"x",yget=bb.y2&&bbt.y2&&"y2"||"y",dx=bb[xget]-bbt[xget],dy=bb[yget]-bbt[yget];o.coordorigin=dx*-zoom+S+dy*-zoom,setCoords(this,1,1,dx,dy,0)}else o.style.filter=E,setCoords(this,split.scalex,split.scaley,split.dx,split.dy,split.rotate);else o.style.filter=E,skew.matrix=Str(matrix),skew.offset=matrix.offset();return oldt&&(this._.transform=oldt),this},elproto.rotate=function(deg,cx,cy){var o=this;if(o.removed)return o;if(updateFollowers(o,"rotate",deg,cx,cy),null!=deg){if(deg=Str(deg).split(separator),deg.length-1&&(cx=toFloat(deg[1]),cy=toFloat(deg[2])),deg=toFloat(deg[0]),null==cy&&(cx=cy),null==cx||null==cy){var bbox=o.getBBox(1);cx=bbox.x+bbox.width/2,cy=bbox.y+bbox.height/2}return o._.dirtyT=1,o.transform(o._.transform.concat([["r",deg,cx,cy]])),o}},elproto.translate=function(dx,dy){var o=this;return o.removed?o:(updateFollowers(o,"translate",dx,dy),dx=Str(dx).split(separator),dx.length-1&&(dy=toFloat(dx[1])),dx=toFloat(dx[0])||0,dy=+dy||0,o._.bbox&&(o._.bbox.x+=dx,o._.bbox.y+=dy),o.transform(o._.transform.concat([["t",dx,dy]])),o)},elproto.scale=function(sx,sy,cx,cy){var o=this;if(o.removed)return o;if(updateFollowers(o,"scale",sx,sy,cx,cy),sx=Str(sx).split(separator),sx.length-1&&(sy=toFloat(sx[1]),cx=toFloat(sx[2]),cy=toFloat(sx[3]),isNaN(cx)&&(cx=null),isNaN(cy)&&(cy=null)),sx=toFloat(sx[0]),null==sy&&(sy=sx),null==cy&&(cx=cy),null==cx||null==cy)var bbox=o.getBBox(1);return cx=null==cx?bbox.x+bbox.width/2:cx,cy=null==cy?bbox.y+bbox.height/2:cy,o.transform(o._.transform.concat([["s",sx,sy,cx,cy]])),o._.dirtyT=1,o},elproto.hide=function(soft){var o=this;return updateFollowers(o,"hide",soft),!o.removed&&(o.node.style.display="none"),o},elproto.show=function(soft){var o=this;return updateFollowers(o,"show",soft),!o.removed&&(o.node.style.display=E),o},elproto._getBBox=function(){var o=this;return o.removed?{}:{x:o.X+(o.bbx||0)-o.W/2,y:o.Y+(o.bby||0)-o.H/2,width:o.W,height:o.H}},elproto.remove=function(){if(!this.removed&&this.parent.canvas){var i,o=this,node=_raphael2["default"]._engine.getNode(o),paper=o.paper,shape=o.shape;for(paper.__set__&&paper.__set__.exclude(o),eve.unbind("raphael.*.*."+o.id),shape&&shape.parentNode.removeChild(shape),node.parentNode&&node.parentNode.removeChild(node);i=o.followers.pop();)i.el.remove();for(;i=o.bottom;)i.remove();if(o._drag&&o.undrag(),o.events)for(;i=o.events.pop();)i.unbind();o.removeData(),delete paper._elementsById[o.id],_raphael2["default"]._tear(o,o.parent);for(var i in o)o[i]="function"==typeof o[i]?_raphael2["default"]._removedFactory(i):null;o.removed=!0}},elproto.attr=function(name,value){if(this.removed)return this;if(null==name){var res={};for(var a in this.attrs)this.attrs[has](a)&&(res[a]=this.attrs[a]);return res.gradient&&"none"==res.fill&&(res.fill=res.gradient)&&delete res.gradient,res.transform=this._.transform,res.visibility="none"===this.node.style.display?"hidden":"visible",res}if(null==value&&_raphael2["default"].is(name,"string")){if("fill"==name&&"none"==this.attrs.fill&&this.attrs.gradient)return this.attrs.gradient;if("visibility"==name)return"none"===this.node.style.display?"hidden":"visible";for(var names=name.split(separator),out={},i=0,ii=names.length;i<ii;i++)name=names[i],name in this.attrs?out[name]=this.attrs[name]:_raphael2["default"].is(this.ca[name],"function")?out[name]=this.ca[name].def:out[name]=_raphael2["default"]._availableAttrs[name];return ii-1?out:out[names[0]]}if(this.attrs&&null==value&&_raphael2["default"].is(name,"array")){for(out={},i=0,ii=name.length;i<ii;i++)out[name[i]]=this.attr(name[i]);return out}var params;if(null!=value&&(params={},params[name]=value),null==value&&_raphael2["default"].is(name,"object")&&(params=name),!1!==_raphael2["default"].stopEvent)for(var key in params)eve("raphael.attr."+key+"."+this.id,this,params[key],key);if(params){var todel={};for(key in this.ca)if(this.ca[key]&&params[has](key)&&_raphael2["default"].is(this.ca[key],"function")&&!this.ca["_invoked"+key]){this.ca["_invoked"+key]=!0;var par=this.ca[key].apply(this,[].concat(params[key]));delete this.ca["_invoked"+key];for(var subkey in par)par[has](subkey)&&(params[subkey]=par[subkey]);this.attrs[key]=params[key],!1===par&&(todel[key]=params[key],delete params[key])}"text"in params&&"text"==this.type&&(_raphael2["default"].is(params.text,"array")&&(params.text=params.text.join("\n")),this.textpath.string=params.text.replace(/<br\s*?\/?>/gi,"\n")),setFillAndStroke(this,params);var follower;for(i=0,ii=this.followers.length;i<ii;i++)follower=this.followers[i],follower.cb&&!follower.cb.call(follower.el,params,this)||follower.el.attr(params);for(var subkey in todel)params[subkey]=todel[subkey]}return this},elproto.blur=function(size){var s=this.node.runtimeStyle,f=s.filter;return f=f.replace(blurregexp,E),0!=+size?(this.attrs.blur=size,s.filter=f+S+" progid:DXImageTransform.Microsoft.Blur(pixelradius="+(+size||1.5)+")",s.margin=_raphael2["default"].format("-{0}px 0 0 -{0}px",round(+size||1.5))):(s.filter=f,s.margin=0,delete this.attrs.blur),this},elproto.on=function(eventType,handler){return this.removed?this:"dragstart"===eventType?(this.drag(null,handler),this):"dragmove"===eventType?(this.drag(handler),this):"dragend"===eventType?(this.drag(null,null,handler),this):(this.node.attachEvent?this.node.attachEvent("on"+eventType,handler):this.node["on"+eventType]=function(){var evt=_raphael2["default"]._g.win.event;evt.target=evt.srcElement,handler(evt)},this)},elproto.off=function(eventType,handler){return this.removed?this:"dragstart"===eventType?(this.undragstart(),this):"dragmove"===eventType?(this.undragmove(),this):"dragend"===eventType?(this.undragend(),this):(this.node.attachEvent?this.node.detachEvent("on"+eventType,handler):this.node["on"+eventType]=null,this)},_raphael2["default"]._engine.getNode=function(el){var node=el.node||el[0].node;return node.clipRect||node},_raphael2["default"]._engine.getLastNode=function(el){var node=el.node||el[el.length-1].node;return node.clipRect||node},_raphael2["default"]._engine.group=function(vml,id,group){var el=_raphael2["default"]._g.doc.createElement("div"),p=new Element(el,vml,group);return el.style.cssText=cssDot,p._id=id||E,id&&(el.className="raphael-group-"+p.id+"-"+id),(group||vml).canvas.appendChild(el),p.type="group",p.canvas=p.node,p.transform=_raphael2["default"]._engine.group.transform,p.top=null,p.bottom=null,p},_raphael2["default"]._engine.group.transform=function(tstr){if(null==tstr)return this._.transform;var matrix,offset,tx,ty,o=this,s=o.node.style,c=o.clip,vbs=o.paper._viewBoxShift,vbt=vbs?"s"+[vbs.scale,vbs.scale]+"-1-1t"+[vbs.dx,vbs.dy]:E;return vbs&&(tstr=Str(tstr).replace(/\.{3}|\u2026/g,o._.transform||E)),_raphael2["default"]._extractTransform(o,vbt+tstr),matrix=o.matrix,offset=matrix.offset(),tx=toFloat(offset[0])||0,ty=toFloat(offset[1])||0,s.left=tx+"px",s.top=ty+"px",s.zoom=(o._.tzoom=matrix.get(0))+E,c&&(s.clip=_raphael2["default"].format("rect({1}px {2}px {3}px {0}px)",[c[0]-tx,c[1]-ty,c[2]-tx,c[3]-ty])),o},_raphael2["default"]._engine.path=function(vml,attrs,group){var el=createNode("shape");el.style.cssText=cssDot,el.coordsize=zoom+S+zoom,el.coordorigin=vml.coordorigin;var p=new Element(el,vml,group);return p.type=attrs.type||"path",p.path=[],p.Path=E,attrs.type&&delete attrs.type,setFillAndStroke(p,attrs),applyCustomAttributes(p,attrs),p},_raphael2["default"]._engine.rect=function(vml,attrs,group){var path=_raphael2["default"]._rectPath(attrs.x,attrs.y,attrs.w,attrs.h,attrs.r);attrs.path=path,attrs.type="rect";var res=vml.path(attrs,group),a=res.attrs;return res.X=a.x,res.Y=a.y,res.W=a.width,res.H=a.height,a.path=path,res},_raphael2["default"]._engine.ellipse=function(vml,attrs,group){attrs.type="ellipse";var res=vml.path(attrs,group),a=res.attrs;return res.X=a.x-a.rx,res.Y=a.y-a.ry,res.W=2*a.rx,res.H=2*a.ry,res},_raphael2["default"]._engine.circle=function(vml,attrs,group){attrs.type="circle";var res=vml.path(attrs,group),a=res.attrs;return res.X=a.x-a.r,res.Y=a.y-a.r,res.W=res.H=2*a.r,res},_raphael2["default"]._engine.image=function(vml,attrs,group){var path=_raphael2["default"]._rectPath(attrs.x,attrs.y,attrs.w,attrs.h);attrs.path=path,attrs.type="image",attrs.stroke="none";var res=vml.path(attrs,group),a=res.attrs,node=res.node,fill=node.getElementsByTagName("fill")[0];return a.src=attrs.src,res.X=a.x=attrs.x,res.Y=a.y=attrs.y,res.W=a.width=attrs.w,res.H=a.height=attrs.h,fill.parentNode==node&&node.removeChild(fill),fill.rotate=!0,fill.src=a.src,fill.type="tile",res._.fillpos=[a.x,a.y],res._.fillsize=[a.w,a.h],node.appendChild(fill),setCoords(res,1,1,0,0,0),res},_raphael2["default"]._engine.text=function(vml,attrs,group,css){var el=createNode("shape"),path=createNode("path"),o=createNode("textpath");x=attrs.x||0,y=attrs.y||0,text=attrs.text,path.v=_raphael2["default"].format("m{0},{1}l{2},{1}",round(attrs.x*zoom),round(attrs.y*zoom),round(attrs.x*zoom)+1),path.textpathok=!0,o.string=Str(attrs.text).replace(/<br\s*?\/?>/gi,"\n"),o.on=!0,el.style.cssText=cssDot,el.coordsize=zoom+S+zoom,el.coordorigin="0 0";var p=new Element(el,vml,group);return p.shape=el,p.path=path,p.textpath=o,p.type="text",p.attrs.text=Str(attrs.text||E),p.attrs.x=attrs.x,p.attrs.y=attrs.y,p.attrs.w=1,p.attrs.h=1,css&&p.css&&p.css(css,undefined,!0),setFillAndStroke(p,attrs),applyCustomAttributes(p,attrs),el.appendChild(o),el.appendChild(path),p},_raphael2["default"]._engine.setSize=function(width,height){var cs=this.canvas.style;return this.width=width,this.height=height,width==+width&&(width+="px"),height==+height&&(height+="px"),width&&(cs.width=width),height&&(cs.height=height),cs.clip="rect(0 "+cs.width+" "+cs.height+" 0)",this._viewBox&&_raphael2["default"]._engine.setViewBox.apply(this,this._viewBox),this},_raphael2["default"]._engine.setViewBox=function(x,y,w,h,fit){eve("raphael.setViewBox",this,this._viewBox,[x,y,w,h,fit]);var H,W,width=this.width,height=this.height,size=1/mmax(w/width,h/height);return fit&&(H=height/h,W=width/w,w*H<width&&(x-=(width-w*H)/2/H),h*W<height&&(y-=(height-h*W)/2/W)),this._viewBox=[x,y,w,h,!!fit],this._viewBoxShift={dx:-x,dy:-y,scale:size},this.forEach(function(el){el.transform("...")}),this};var createNode;_raphael2["default"]._engine.initWin=function(win){var doc=win.document;doc.createStyleSheet().addRule(".rvml","behavior:url(#default#VML)");try{!doc.namespaces.rvml&&doc.namespaces.add("rvml","urn:schemas-microsoft-com:vml"),createNode=_raphael2["default"]._createNode=function(tagName,attrs){var prop,el=doc.createElement("<rvml:"+tagName+' class="rvml">');for(prop in attrs)el[prop]=Str(attrs[prop]);return el}}catch(e){createNode=_raphael2["default"]._createNode=function(tagName,attrs){var prop,el=doc.createElement("<"+tagName+' xmlns="urn:schemas-microsoft.com:vml" class="rvml">');for(prop in attrs)el[prop]=Str(attrs[prop]);return el}}},_raphael2["default"]._engine.initWin(_raphael2["default"]._g.win),_raphael2["default"]._engine.create=function(){var con=_raphael2["default"]._getContainer.apply(0,arguments),container=con.container,height=con.height,width=con.width,x=con.x,y=con.y;if(!container)throw new Error("VML container not found.");var res=new _raphael2["default"]._Paper,c=res.canvas=_raphael2["default"]._g.doc.createElement("div"),cs=c.style;return x=x||0,y=y||0,width=width||512,height=height||342,res.width=width,res.height=height,width==+width&&(width+="px"),height==+height&&(height+="px"),res.coordsize=216e5+S+216e5,res.coordorigin="0 0",c.id="raphael-paper-"+res.id,res.span=_raphael2["default"]._g.doc.createElement("span"),res.span.style.cssText="position:absolute;left:-9999em;top:-9999em;padding:0;margin:0;line-height:1;",c.appendChild(res.span),cs.cssText=_raphael2["default"].format("top:0;left:0;width:{0};height:{1};display:inline-block;cursor:default;position:relative;clip:rect(0 {0} {1} 0);overflow:hidden",width,height),1==container?(_raphael2["default"]._g.doc.body.appendChild(c),cs.left=x+"px",cs.top=y+"px",cs.position="absolute"):container.firstChild?container.insertBefore(c,container.firstChild):container.appendChild(c),res.renderfix=function(){},res},_raphael2["default"].prototype.clear=function(){var c;for(eve("raphael.clear",this);c=this.bottom;)c.remove();this.canvas.innerHTML=E,this.span=_raphael2["default"]._g.doc.createElement("span"),this.span.style.cssText="position:absolute;left:-9999em;top:-9999em;padding:0;margin:0;line-height:1;display:inline;",this.canvas.appendChild(this.span),this.bottom=this.top=null},_raphael2["default"].prototype.remove=function(){var i;for(eve("raphael.remove",this);i=this.bottom;)i.remove();this.canvas.parentNode.removeChild(this.canvas);for(i in this)this[i]="function"==typeof this[i]?_raphael2["default"]._removedFactory(i):null;return!0};var setproto=_raphael2["default"].st;for(var method in elproto)elproto[has](method)&&!setproto[has](method)&&(setproto[method]=function(methodname){return function(){var arg=arguments;return this.forEach(function(el){el[methodname].apply(el,arg)})}}(method))}/**!

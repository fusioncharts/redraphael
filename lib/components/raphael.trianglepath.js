...
_window.Raphael && (_window.Raphael.define && function (R) {
    ...
    R.define({
        ...
        trianglepath: function trianglepath() {
            ...
            return face.attr("trianglepath", [args[0], args[1], args[2], args[3], args[4], args[5], r1, r2, r3]);
        },
        ...
        fn: {
            ...
            enclosedAngles: function enclosedAngles() {
                ...
                return [acos((pow(edges[0], 2) + pow(edges[2], 2) - pow(edges[1], 2)) / (2 * edges[0] * edges[2])), acos((pow(edges[0], 2) + pow(edges[1], 2) - pow(edges[2], 2)) / (2 * edges[0] * edges[1])), acos((pow(edges[2], 2) + pow(edges[1], 2) - pow(edges[0], 2)) / (2 * edges[2] * edges[1]))];
            },
        ...
        ca: {
            trianglepath: function trianglepath(x1, y1, x2, y2, x3, y3, r1, r2, r3) {
                ...
                if (r1 || r2 || r3) {
                    ...
                    curveDistance = [mathMin(r1, inradius) / tan(angles[0] / 2), mathMin(r2, inradius) / tan(angles[1] / 2), mathMin(r3, inradius) / tan(angles[2] / 2)];

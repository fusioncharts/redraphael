...
_window.Raphael && _window.Raphael.define && function (R) {
    ...
    R.define({
        ...
        ca: {
            polypath: function polypath(sides, cx, cy, r, angle, dip) {
            ...
            "polypath-sides": function polypathSides(value) {
                var o = this,
            ...
            "polypath-cx": function polypathCx(value) {
                var o = this,
                    attr = o.attrs.polypath;
            ...
            "polypath-cy": function polypathCy(value) {
                var o = this,
                    attr = o.attrs.polypath;
            ...
            "polypath-radius": polypathRadius = function polypathRadius(value) {
                var o = this,
                    attr = o.attrs.polypath;
            ...
            "polypath-angle": function polypathAngle(value) {
                var o = this,
                    attr = o.attrs.polypath;
            ...
            "polypath-dip": function polypathDip(value) {
                var o = this,
                    attr = o.attrs.polypath;

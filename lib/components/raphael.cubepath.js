...
_window.Raphael && (_window.Raphael.define && function (R) {
    ...
    R.define({
        ...
        cubepath: function cubepath() {
            ...
            return face.attr(CUBEPATH, [args[0] || 0, args[1] || 0, args[2] || 0, args[3] || 0, args[4] || 0, args[5] || 0]);
        },

        ca: {
            cubepath: function cubepath(x, y, width, height, zw, zh) {
                var o = this,
                    t = o._.cubetop,
                    s = o._.cubeside,
                    negWidth = -width,
            ...
            zw: function zw(value) {
                var attr = this.attr(CUBEPATH);
                this.attr(CUBEPATH, (attr[4] = value, attr));
                return false;
            },

            zh: function zh(value) {
                var attr = this.attr(CUBEPATH);
            ...
            "drop-shadow": function dropShadow(dx, dy, spread, color) {
                var o = this,
                    top = o._.cubetop,
                    side = o._.cubeside;
            ...
            "fill": function fill(color, nogradient) {
                ...
                if (nogradient) {
                    ...
                    top.attr(FILL, [45 + R.deg(mathAtan2(zh, zw + width)), R.tintshade(rgba, -0.78).rgba, R.tintshade(rgba, 0.22).rgba].join(HYP));
                    /* @note

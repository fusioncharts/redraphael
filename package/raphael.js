...
var _raphael3 = __webpack_require__(76);

var _raphael4 = _interopRequireDefault(_raphael3);

var _raphael5 = __webpack_require__(77);

var _raphael6 = _interopRequireDefault(_raphael5);

var _raphael7 = __webpack_require__(78);

var _raphael8 = _interopRequireDefault(_raphael7);

var _raphael9 = __webpack_require__(79);
...
var _eve2 = __webpack_require__(75);
...
var bucketProto = Bucket.prototype;
...
bucketProto._getTotalIteration = function () {
    ...
    var repeats = (0, _keys2['default'])(this.iteratee);
    for (var _i = 0, len = repeats.length; _i < len; _i++) {
        this.totalIteration = lcm(this.totalIteration, +repeats[_i]);
    }
...
bucketProto.getBucket = function () {
    var _this = this,
        ...
        repeats = (0, _keys2['default'])(iteratee).sort(sortFn),
        step = void 0,
        list = void 0,
        _cost = this._cost,
        nRepeats = repeats.length,
        len = _this._getTotalIteration();
    for (var j = 0; j < nRepeats; j++) {
        step = +repeats[j];
        for (var _i2 = step - 1; _i2 < len; _i2 += step) {
            bucket[_i2] || (bucket[_i2] = {});
            // stores the list of the quantum bucket
            list = bucket[_i2].list || (bucket[_i2].list = []);
            list.push(step);
            // calculate total cost for current bucket
            bucket[_i2].totalCost || (bucket[_i2].totalCost = 0);
            bucket[_i2].totalCost += _cost[step];
        }
    }
    return bucket;
};
